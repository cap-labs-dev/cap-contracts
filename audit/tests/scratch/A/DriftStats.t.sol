...
/// @notice Measures the sign and size of the creditBackedSupply vs totalDebt drift produced by
/// FloatingMarket._premium's two-part rounding, across accrual cadence and rate configurations.
/// Not an assertion suite: it logs. Read alongside Reserve.t.sol.
contract DriftStatsTest is CapDeployer {
        ...
        internal
    {
        ...
        uint256 worst; // max(debt - credit) seen
        uint256 debtAbove; // accruals ending with debt > credit
        for (uint256 i; i < n; ++i) {
