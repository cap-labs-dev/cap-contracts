...
/// @notice Round-2 port of audit/tests/scratch/D/D4_FloatingBorrowUnhealthy.t.sol (L-3). setLt may
/// drop lt below ltv (BaseMarket.sol:82 comment). FixedMarket._borrow asserts health afterwards
/// (FixedMarket.sol:211); FloatingMarket.borrow (FloatingMarket.sol:63-77) does not.
contract L3_FloatingBorrowUnhealthy is CapDeployer {
