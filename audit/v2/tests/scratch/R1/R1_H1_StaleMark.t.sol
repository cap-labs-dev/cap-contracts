...
/// Round-2 port of round-1 C1_StaleMark (H-1). Assertions unchanged; only harness API differs
/// (`_setPrice` in place of `oracle.setPrice`, test-contract is the curator).
