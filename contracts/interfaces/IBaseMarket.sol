...
interface IBaseMarket {
    ...
    /// @dev Sum of each attached tranche's {ITranche-capitalLimit}, then `min(loanToValue, liquidationThreshold)`.
    /// Guardian tightening of `liquidationThreshold` below `loanToValue` cuts new credit here.
