...
interface IInterestRateModel {
    ...
    /// @notice The default buffer is below 10% or is not strictly below the liquidation threshold
    error InvalidBuffer();
    ...
    /// @param liquidationThreshold The default liquidation threshold for new markets in ray decimals (at most one ray, above buffer)
    /// @param buffer The default liquidation buffer for new markets in ray decimals (at least 0.1e27, strictly below liquidationThreshold)
    ...
    /// @dev Must be at least 0.1e27 and strictly below {liquidationThreshold}.
