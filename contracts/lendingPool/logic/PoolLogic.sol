...
library PoolLogic {
    ...
    function executeInitReserve(
        ...
        address cToken = CloneLogic.clone(params.cTokenInstance);
        address vToken = CloneLogic.clone(params.vTokenInstance);
        ...
        reservesData.configuration = currentConfig;
    ...
    function executeMintToTreasury(
        ...
        for (uint256 i = 0; i < assets.length; i++) {
            ...
            if (accruedToTreasury != 0) {
                ...
                uint256 amountToMint = accruedToTreasury;
                IAToken(reserve.aTokenAddress).mint(treasury, amountToMint);

                emit MintedToTreasury(treasury, assetAddress, amountToMint);
            }
        }
    }
    ...
    function executeGetUserAccountData(
        ...
        (
            ...
            healthFactor
        ) = GenericLogic.calculateUserAccountData(reservesData, reservesList, _avs, params);
