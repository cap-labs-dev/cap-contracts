...
contract CapToken is UUPSUpgradeable, ERC20PermitUpgradeable, AccessUpgradeable {
    ...
    function initialize(string memory _name, string memory _symbol, address _accessControl) external initializer {
    ...
    function burn(address _from, uint256 _amount) external checkAccess(this.burn.selector) {
        _burn(_from, _amount);
    }
