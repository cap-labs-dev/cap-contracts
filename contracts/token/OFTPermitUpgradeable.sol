...
abstract contract OFTPermitUpgradeable is OFTCoreUpgradeable, ERC20Upgradeable, ERC20PermitUpgradeable {
    /**
    ...
    function __OFTPermit_init(string memory _name, string memory _symbol, address _delegate) internal initializer {
