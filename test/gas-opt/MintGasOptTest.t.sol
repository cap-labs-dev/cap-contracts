...
contract MintGasOptTest is Test {
    ...
    function setUp() public {
        ...
        // Mint some tokens to the minter address
        usdt.mint(user_minter, 1000e18);
        usdc.mint(user_minter, 1000e18);
        usdx.mint(user_minter, 1000e18);
    ...
    function testMintWithUSDT() public {
        ...
        assertGt(cUSD.balanceOf(user_minter), 0, "Should have received cUSD tokens");
    ...
    function testMintWithDifferentPrices() public {
        ...
        assertGe(cUSD.balanceOf(user_minter), expectedMin, "Should have received more cUSD due to higher USDT price");
        assertEq(usdt.balanceOf(address(vault)), amountIn, "Vault should have received USDT");
