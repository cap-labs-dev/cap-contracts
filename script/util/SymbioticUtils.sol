...
contract SymbioticUtils {
    ...
    function getConfig() public view returns (SymbioticConfig memory config) {
        ...
        if (block.chainid == 1) {
            ...
            config.networkRegistry = 0x7d03b7343BF8d5cEC7C0C27ecE084a20113D15C9;
            config.vaultRegistry = 0x407A039D94948484D356eFB765b3c74382A050B4; // == vault registry
            config.networkMetadataService = 0x0F7E58Cc4eA615E8B8BEB080dF8B8FDB63C21496;
            config.networkMiddlewareService = 0x62a1ddfD86b4c1636759d9286D3A0EC722D086e3;
            config.operatorRegistry = 0x6F75a4ffF97326A00e52662d82EA4FdE86a2C548;
            config.operatorMetadataService = 0x0999048aB8eeAfa053bF8581D4Aa451ab45755c9;
            config.vaultOptInService = 0x95CC0a052ae33941877c9619835A233D21D57351;
            config.networkOptInService = 0x58973d16FFA900D11fC22e5e2B6840d9f7e13401;
            config.vaultConfigurator = 0xD2191FE92987171691d552C219b8caEf186eb9cA;
            config.defaultStakerRewardsFactory = 0x70C618a13D1A57f7234c0b893b9e28C5cA8E7f37;
            config.defaultOperatorRewardsFactory = 0x8D6C873cb7ffa6BE615cE1D55801a9417Ed55f9B;
            config.burnerRouterFactory = 0x32e2AfbdAffB1e675898ABA75868d92eE1E68f3b;
        }
    }
